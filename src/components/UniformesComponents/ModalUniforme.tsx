...
const cards: CardInfo[] = [
    {
        ...
        description: "Aqui encontraras la informacion de nuestro uniforme de parada",
                ...
                <div className="tar">
                    ...
                    <div className="contentbox">
                        <div className="content-tar">
                            ...
                            <p>Este uniforme, utilizado por los personajes a la izquierda de la imagen, está diseñado con un estilo elegante y sobrio. El niño viste un abrigo largo a cuadros en tonos grises con detalles blancos y camisa clara debajo, mientras que la niña lleva un suéter negro combinado con una falda a cuadros y un collar llamativo.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    },
    {
        ...
        description: "Aqui encontraras la informacion de nuestro uniforme de Educación Fisica",
                ...
                <div className="tar">
                    ...
                    <div className="contentbox">
                        <div className="content-tar">
                            ...
                            <p>En la parte derecha de la imagen, los personajes lucen un uniforme deportivo más cómodo y funcional. El niño viste una camiseta blanca con detalles azul oscuro y pantalones deportivos del mismo tono, mientras que la niña lleva una camiseta blanca holgada y un pantalón deportivo con franjas.</p>
                        </div>
                    </div>
                </div>
            </div>
