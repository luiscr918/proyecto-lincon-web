const Navegacion = () => {
    return (
        <nav className="absolute border-b border-solid border-prime-gray-200 w-full py-3 bg-inherit">
            <div className="container mx-auto">
                <div className="w-full flex flex-col lg:flex-row">
                    <div className="flex justify-between lg:flex-row">
                        ...
                        <button data-collapse-toggle="navbar-advanced-dropdown" type="button"
                            className="inline-flex items-center p-2 ml-3 text-sm text-gray-500 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
                            aria-controls="navbar-advanced-dropdown" aria-expanded="false">
                    ...
                    <div className="hidden w-full lg:flex lg:pl-11" id="navbar-advanced-dropdown">
                        <ul className="flex items-center max-lg:gap-4 flex-col mt-4 md:mt-0 md:ml-auto lg:flex-row">
                            <li>
                                <a href="javascript:;"
                            ...
                            <li className="relative">
                                <button data-target="megamenu-with-dropdown"
                                ...
                                <div id="megamenu-with-dropdown" aria-labelledby="megamenu-with-dropdown"
                                    className="animate-fade z-10 relative lg:absolute lg:top-14 lg:-left-80 bg-white rounded-lg shadow-[0px_15px_30px_0px_rgba(16,24,40,0.1)] xl:p-8 lg:p-4 p-2 lg:min-w-[280px] md:min-w-[280px] min-w-full open">
                                    <div className="block">
