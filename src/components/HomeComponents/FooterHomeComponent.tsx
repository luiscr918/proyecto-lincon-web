        ...
        <footer className="w-full bg-[#223555]">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 ">
                <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-3 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
                    ...
                    <div className="lg:mx-auto text-left ">
                        <h4 className="text-lg text-white font-medium mb-7">Enlaces de Interes</h4>
                        <ul className="text-sm  transition-all duration-500">
                            <li className="mb-4"><a href="javascript:;" className="text-yellow-400 hover:text-[#c4b264]">Extracurriculares</a></li>
                            <li className="mb-4"><a href="javascript:;" className=" text-yellow-400 hover:text-[#c4b264]">Inicio de clases</a></li>
                            <li className="mb-4 "><a href="javascript:;" className=" text-yellow-400  hover:text-[#c4b264] ">Uniformes</a></li>
                            <li className="mb-4"> <a href="javascript:;" className=" text-yellow-400  hover:text-[#c4b264] ">Costos</a></li>
                        </ul>
                    </div>

                    {/* iconos */}
                    <div>
                        <h4 className="text-lg text-white font-medium mb-7">Siguenos en nuestras redes </h4>
                        ...
                        <div className="flex mt-4 space-x-4  lg:mt-0 ">
                            ...
                            <a href="javascript:;" className="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[linear-gradient(45deg,#FEE411_6.9%,#FEDB16_10.98%,#FEC125_17.77%,#FE983D_26.42%,#FE5F5E_36.5%,#FE2181_46.24%,#9000DC_85.57%)]  hover:bg-gradient-to-b from-gray-900 to-gray-900  ">
                                <svg className="w-[1.25rem] h-[1.25rem] text-white" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="javascript:;" className="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-black hover:bg-gray-900">
                                <svg className="w-[1.25rem] h-[1.25rem] text-white" viewBox="0 0 200 256" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="javascript:;" className="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#337FFF]  hover:bg-gray-900 ">
                                <svg className="w-[1.25rem] h-[1.25rem] text-white" viewBox="0 0 7 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="py-7 border-t border-gray-200">
                    <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                        <span className="text-sm text-gray-500 ">©<a href="https://pagedone.io/">U.E.P</a> Todos los derechos reservados 2025 unidad Educativa Lincoln Larrea Benalcazar</span>
