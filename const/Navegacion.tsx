          ...
          <div className="w-full flex  flex-col lg:flex-row">
            ...
            <div className="hidden w-full lg:flex lg:pl-11 " id="navbar-default-with-dropdown">
              <ul className="flex lg:items-center flex-col mt-4 lg:mt-0 lg:ml-auto lg:flex-row gap-4 lg:gap-0">
                <li>
                  <a href="javascript:;" className="flex items-center justify-between text-white text-sm lg:text-base font-medium hover:text-yellow-400 transition-all duration-500 mb-2 lg:mr-6 md:mb-0 md:mr-3 hover:underline ">Inicio</a>
                </li>
                <li>
                  <a href="javascript:;" className="flex items-center justify-between text-white text-sm lg:text-base font-medium hover:text-yellow-400 transition-all duration-500 mb-2 lg:mr-6 md:mb-0 md:mr-3 hover:underline">Sobre Nosotros</a>
                </li>
                <li className="relative">
                  <button data-target="dropdown-default" className="dropdown-toggle flex items-center lg:justify-between text-white text-sm lg:text-base font-medium hover:text-prime-blue-700 transition-all duration-500 lg:mb-0 lg:mr-6  mr-auto text-left  ">Enlances de Interes <svg className="w-3 h-2 ml-1.5 " width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li className="flex items-center">
                  <a href="javascript:;" className="flex-1 flex items-center justify-between text-white text-sm lg:text-base font-medium hover:text-yellow-400 hover:underline transition-all duration-500 mb-2 lg:mr-6 md:mb-0 md:mr-3">Cotactanos</a>
                </li>
                <a href="https://whatsapp.com/channel/0029Vahz9mbJpe8jMkAAWj12" className="w-6 h-6 flex items-center relative overflow-hidden justify-center rounded-full bg-white shadow-md shadow-gray-200 group transition-all duration-300 ml-2">
